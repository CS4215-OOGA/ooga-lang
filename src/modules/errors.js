...
var UndefinedImportError = /** @class */ (function (_super) {
    __extends(UndefinedImportError, _super);
    function UndefinedImportError(symbol, moduleName, node) {
        var _this = _super.call(this, node) || this;
        _this.symbol = symbol;
        _this.moduleName = moduleName;
        return _this;
    }
    UndefinedImportError.prototype.explain = function () {
        return "'".concat(this.moduleName, "' does not contain a definition for '").concat(this.symbol, "'");
    };
    UndefinedImportError.prototype.elaborate = function () {
        return "Check your imports and make sure what you're trying to import exists!";
    };
    return UndefinedImportError;
